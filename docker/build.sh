...
# This script builds the Docker image for the KUKA AMR Connector.
...
IMAGE_NAME="us-central1-docker.pkg.dev/inorbit-integrations/connectors/inorbit_kuka_connector"
IMAGE_NAME_SHORT="inorbit_kuka_connector"
