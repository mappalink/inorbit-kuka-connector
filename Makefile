...
bump:
	...
	git commit -m "Bump inorbit-kuka-connector version: $${old_version} → $${new_version}"; \
	git tag -a "inorbit-kuka-connector-v$${new_version}" -m "Bump inorbit-kuka-connector version: $${old_version} → $${new_version}"; \
