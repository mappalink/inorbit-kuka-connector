...
class TestExtractJobKv:
    ...
    def test_executing_job(self):
        job = {
            "jobCode": "T001",
            "status": 20,
            "targetCellCode": "HEAL-002-90",
            "beginCellCode": "HEAL-002-80",
            "finalNodeCode": "HEAL-002-90",
        ...
        assert kv["job_target_node"] == "HEAL-002-90"
        assert kv["job_begin_node"] == "HEAL-002-80"
        assert kv["job_final_node"] == "HEAL-002-90"
